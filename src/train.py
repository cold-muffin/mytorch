...
def create_model(num_params: int):
...
def train_epoch(model: Sequence[Number], data_set: Sequence[Sequence[int]], loss_fn: Callable[[Sequence[int], Sequence[Number]], Number], lr=0.001):
